...
int main(void){
  ...
  for(int i = 0;i<100;i+=4){
		if(*(pchar9+i+1) != *(pchar+i+1) && *(pchar9+i+2) != *(pchar+i+2) && *(pchar9+i+3) != *(pchar+i+3)){
				*(pchar9+i+1) = *(pchar6+i+1)+*(pchar7+i+1);
				*(pchar9+i+2) = *(pchar6+i+2)+*(pchar7+i+2);
				*(pchar9+i+3) = *(pchar6+i+3)+*(pchar7+i+3);
		}
  }
